...
import { fileToWorkbook, timeConverter } from './util/convert';
...
export default function Home() {
  ...
  //       }
  //       const serieDataPoint = { x: new Date(row.Date).getTime() / 1000, y: (parseInt(row.Place)+Math.random())};
  //       console.log( cleanName, serieDataPoint);
  //       findSerie.data.push( serieDataPoint );
  ...
  // //function rowToBumpSerie( series:any,  )
